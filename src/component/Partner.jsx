        ...
        <Row>
          ...
          <Col xs={12}>
            <div className="partner-item d-flex flex-wrap justify-content-center">
              <div className="partner-item-single" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="" data-aos-offset="0">
                <div className="borderTop"></div>
                <div className="borderLeft"></div>
                <img src={img1} alt="" />
              </div>
              <div className="partner-item-single" data-aos="fade-left" data-aos-duration="1400" data-aos-delay="" data-aos-offset="0">
                <div className="borderTop"></div>
                <div className="borderLeft"></div>
                <img src={img2} alt="" />
              </div>
              <div className="partner-item-single" data-aos="fade-left" data-aos-duration="1600" data-aos-delay="" data-aos-offset="0">
                <div className="borderTop"></div>
                <div className="borderLeft"></div>
                <img src={img3} alt="" />
              </div>
              <div className="partner-item-single" data-aos="fade-left" data-aos-duration="1800" data-aos-delay="" data-aos-offset="0">
                <div className="borderTop"></div>
                <div className="borderLeft"></div>
                <img src={img4} alt="" />
              </div>
              <div className="partner-item-single" data-aos="fade-left" data-aos-duration="2000" data-aos-delay="" data-aos-offset="0">
                <div className="borderTop"></div>
                <div className="borderLeft"></div>
                <img src={img5} alt="" />
              </div>
